...
public class BoardView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        System.out.println("### -> "+mGame.getBoardState());
        ...
        for (int i = 0; i < TicTacToeGame.BOARD_SIZE; i++) {
            ...
            if (mGame != null && Objects.equals(mGame.getBoardOccupant(i), TicTacToeGame.PLAYER_1)) {
                System.out.println("### PLAYER_1 FOUND in  "+i);
            ...
            else if (mGame != null && Objects.equals(mGame.getBoardOccupant(i), TicTacToeGame.PLAYER_2)) {
                System.out.println("### PLAYER_ FOUND in  "+i);
